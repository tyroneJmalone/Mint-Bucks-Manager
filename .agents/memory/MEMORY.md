- [Mint Bucks architecture](mint-bucks-architecture.md) — rewards concurrency invariants; paid-date gating + lookback-only fetch; PATCH nullable clear = send null; scan auto-creates customers.
