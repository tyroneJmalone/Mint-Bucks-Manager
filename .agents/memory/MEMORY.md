- [Mint Bucks architecture](mint-bucks-architecture.md) — @swc/helpers explicit dep; email non-blocking; PATCH nullable clear = send null; rewards concurrency invariants; scan auto-creates customers.
